...
//                      自定义数据区
/*************************************************************/
//Tips 首项设置为true时 常用参数可以运行时改变 输入首字母加参数即可
//     eg. M2：两人组队 F2：点击中间的大蛇
//支持快速更改参数
...
Sub full()
    ...
    While 1
        ...
        Delay delayTime/10
        //开始战斗
        If BackgroundPointColor("60B2F4", 780,500) Then //开始战斗起来
            Select Case member
            Case 2
        ...
        Delay delayTime/10
        //战斗状态
        If BackgroundPointColor("A2C4D5", 149, 67) Then //左上角出现退出、好友、及聊天
            Delay delayTime/10
            //准备
